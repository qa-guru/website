<template>
  <div name="experts" id="experts" class="mt-16 md:mt-32 mb-16">
    ...
    <div
      class="flex flex-col md:flex-row flex-wrap space-y-6 md:space-y-0 md:space-x-16 justify-center md:justify-between mt-10 md:mt-24"
    >
      <div class="flex flex-1 flex-col">
        <img src="~/assets/photos/eroshenko.png" />
        <div
      ...
      <div class="flex flex-1 flex-col">
        <img src="~/assets/photos/vinogradov.png" />
        <div
          class="rounded-lg p-4 mt-4"
          style="box-shadow: 0px 0px 32px rgba(0, 0, 0, 0.1);"
        >
      ...
      <div class="flex flex-1 flex-col">
        <img src="~/assets/photos/orlov.png" />
        <div
          class="rounded-lg p-4 mt-4"
          style="box-shadow: 0px 0px 32px rgba(0, 0, 0, 0.1);"
        >
